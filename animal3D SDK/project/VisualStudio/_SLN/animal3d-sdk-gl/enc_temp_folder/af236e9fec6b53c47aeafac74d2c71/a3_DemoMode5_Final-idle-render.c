	...
	a3f32 const textAlign, a3f32 const textDepth, a3f32 const textOffsetDelta, a3f32 textOffset)
{
	...
	a3byte const* renderTargetName_light[final_renderTargetLight_max] = {
...
void a3final_render(a3_DemoState const* demoState, a3_DemoMode5_Final const* demoMode, a3f64 const dt)
{
	...
	const a3_Texture* const* textureSet[finalMaxCount_sceneObject] = {
		...
		demoState->texSet_earth,	// teapot2
	...
	const a3_DemoStateShaderProgram* renderProgram[final_renderMode_max][finalMaxCount_sceneObject] = {
		{
			0, 0, 0, 0, 0,						// 1, 2, 3, 4, 5,
			demoState->prog_drawPhongNM_ubo,	// 6 Teapot
			demoState->prog_drawPhongNM_ubo,	// 7 Torus
			demoState->prog_drawPhongNM_ubo,	// 8 Teapot
	...
	const a3_Framebuffer* writeFBO[final_renderPass_max] = {
		...
		demoState->fbo_c16x4 + 2,			// final blur
	...
	currentWriteFBO = writeFBO[final_renderPassBright2];
	a3framebufferActivate(currentWriteFBO);
	...
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurH2];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderUniformSendFloat(a3unif_vec2, currentDemoProgram->uAxis, 1, pixelSize.v);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurV2];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderProgramActivate(currentDemoProgram->program);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBright4];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderUniformSendFloat(a3unif_vec2, currentDemoProgram->uAxis, 1, pixelSize.v);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurH4];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderUniformSendFloat(a3unif_vec2, currentDemoProgram->uAxis, 1, pixelSize.v);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurV4];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderProgramActivate(currentDemoProgram->program);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBright8];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderUniformSendFloat(a3unif_vec2, currentDemoProgram->uAxis, 1, pixelSize.v);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurH8];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	a3shaderUniformSendFloat(a3unif_vec2, currentDemoProgram->uAxis, 1, pixelSize.v);
	a3framebufferBindColorTexture(currentWriteFBO, a3tex_unit00, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurV8];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();

	currentDemoProgram = demoState->prog_postBlend;
	a3shaderProgramActivate(currentDemoProgram->program);
	a3framebufferBindColorTexture(writeFBO[final_renderPassComposite], a3tex_unit00, 0);
	a3framebufferBindColorTexture(writeFBO[final_renderPassBlurV2], a3tex_unit01, 0);
	a3framebufferBindColorTexture(writeFBO[final_renderPassBlurV4], a3tex_unit02, 0);
	a3framebufferBindColorTexture(writeFBO[final_renderPassBlurV8], a3tex_unit03, 0);
	currentWriteFBO = writeFBO[final_renderPassBlurFinal];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	currentWriteFBO = writeFBO[final_renderPassDisplay];
	a3framebufferActivate(currentWriteFBO);
	a3vertexDrawableRenderActive();
	...
	case final_renderPassBlurFinal:
