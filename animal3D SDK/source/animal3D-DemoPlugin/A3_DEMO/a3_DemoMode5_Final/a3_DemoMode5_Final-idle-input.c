...
/*
	...
	a3_DemoMode5_Final-idle-input.c
...
void a3final_input_keyCharPress(a3_DemoState const* demoState, a3_DemoMode5_Final* demoMode, a3i32 const asciiKey, a3i32 const state)
{
	switch (asciiKey)
	{
		...
		a3demoCtrlCasesLoop(demoMode->renderMode, final_renderMode_max, 'k', 'j');
		...
		a3demoCtrlCasesLoop(demoMode->renderPipeline, final_renderPipe_max, 'H', 'G');

		// toggle render pass
		a3demoCtrlCasesLoop(demoMode->renderPass, final_renderPass_max, 'K', 'J');
	}
}
