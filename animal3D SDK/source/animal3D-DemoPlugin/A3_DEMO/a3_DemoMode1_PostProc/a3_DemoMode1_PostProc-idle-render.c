...
void a3postproc_render(a3_DemoState const* demoState, a3_DemoMode1_PostProc const* demoMode, a3f64 const dt)
{
	...
	const a3_Framebuffer* writeFBO[postproc_renderPass_max] = {
		...
		demoState->fbo_c16x4_d24s8,			//Scene pass
		demoState->fbo_c16_szHalf + 0,		//Bright pass half
		demoState->fbo_c16_szHalf + 1,		//Blur Horizontal half
		demoState->fbo_c16_szHalf + 2,		//Blur Vertical half
		demoState->fbo_c16_szQuarter + 0,	//Bright pass quarter
		demoState->fbo_c16_szQuarter + 1,	//Blur Horizontal quarter
		demoState->fbo_c16_szQuarter + 2,   //Blur Vertical quarter
		demoState->fbo_c16_szEighth + 0,	//Bright pass eighth
		demoState->fbo_c16_szEighth + 1,	//Blur Horizontal eighth
		demoState->fbo_c16_szEighth + 2,    //Blur Vertical eighth
